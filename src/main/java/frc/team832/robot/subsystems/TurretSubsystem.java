...
//            LinearSystemId.createSingleJointedArmSystem(DCMotor.getNEO(2), TurretValues.kTurretMOI, TurretValues.turretGearing);
...
//                    VecBuilder.fill(0.01, 0.01), // How accurate we think our encoder position
...
//        m_lastProfiledReference = (new TrapezoidProfile(m_constraints, goal, m_lastProfiledReference)).calculate(TurretValues.ControlLoopPeriod);
...
//        m_loop.predict(TurretValues.ControlLoopPeriod);
...
//                    m_loop,
//                    Units.rotationsPerMinuteToRadiansPerSecond(turretMotor.getSensorVelocity() / TurretValues.turretGearing),
...
//    }
    ...
    public void setIntake() {
        setTurretTargetDegrees(TurretValues.IntakeOrientationDegrees, false);
    }
